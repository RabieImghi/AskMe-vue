            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Number Of Users</h5>
                        </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card l-bg-blue-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Number Of Category</h5>
                        </div>
                        <div class="row align-items-center mb-2 d-flex">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center mb-0">
                            ...
                            <div class="col-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card l-bg-green-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Number Of Posts</h5>
                        </div>
                        <div class="row align-items-center mb-2 d-flex">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center mb-0">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card l-bg-orange-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Number Of Answers</h5>
                        </div>
                        <div class="row align-items-center mb-2 d-flex">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center mb-0">
                            ...
                            <div class="col-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-reply" viewBox="0 0 16 16">
                        ...
                        <div class="progress mt-1 " data-height="8" style="height: 8px;">
                            ...
                            :style="{ width: '19%'}" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
